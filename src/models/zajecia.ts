...
class Zajecia{ 
    ...
    constructor(nazwa_przedmiotu: string, nr_lekcji: number, dzien: DniTygodnia, klasa: Klasa, nauczyciel: Nauczyciel, sala: Sala, typ: TypZajec){
    ...
    public get Dzien(): DniTygodnia{  //nie wiem czy to nie mozna stringa?
        return this.dzien
    }

    public get Typ(): TypZajec{  //nie wiem czy to nie mozna stringa?
        return this.typ
    }
